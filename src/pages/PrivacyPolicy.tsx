...
import { ArrowLeft, Shield, Eye, Database, Cookie, Globe, Users, Lock, Mail } from 'lucide-react';
      ...
      <div className="border-b border-gray-200 dark:border-[#3C3C3C] bg-white dark:bg-[#1C1C1C] sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-white">Privacy Policy</h1>
