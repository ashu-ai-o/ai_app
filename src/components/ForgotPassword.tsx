      ...
      <div className="min-h-screen bg-white dark:bg-black flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <div className="text-center">
            ...
            <h1 className="text-gray-900 dark:text-white text-xl sm:text-2xl font-semibold mb-4">
              Check your email
            </h1>
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full bg-gray-900 dark:bg-white text-white dark:text-black font-semibold py-3 px-4 rounded-lg hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors"
              >
                Back to sign in
              </button>
    ...
    <div className="min-h-screen bg-white dark:bg-black flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-gray-900 dark:text-white text-xl sm:text-2xl font-semibold mb-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-gray-900 dark:bg-white text-white dark:text-black font-semibold py-3 px-4 rounded-lg hover:bg-gray-800 dark:hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2 text-sm sm:text-base"
          >
            {isLoading ? (
              <>
        ...
        <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700">
          ...
          <button className="mt-2 text-xs sm:text-sm text-blue-400 hover:text-blue-300 transition-colors font-medium">
            Contact support →
          </button>
        </div>
      </div>
