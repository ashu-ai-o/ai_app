    ...
    <div className="min-h-screen bg-white dark:bg-black flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-gray-900 dark:text-white text-2xl font-semibold mb-2">Sign in to your account</h1>
          <p className="text-gray-600 dark:text-gray-400 text-sm">Welcome back! Please enter your details.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center">
              ...
              />
              <span className="ml-2 text-sm text-gray-600 dark:text-gray-300">Remember for 30 days</span>
            </label>
            <button
              type="button"
